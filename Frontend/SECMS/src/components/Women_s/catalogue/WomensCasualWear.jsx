...
import './WomensCasualWear.css';

function WomensCasualWear() {
  ...
  const fetchProducts = async () => {
    ...
    setError('');
    try {
      const response = await fetch('/api/products/catalogue/FEMALE/CASUAL_WEAR');
      if (response.ok) {
    ...
    <>
      ...
      <main className="catalogue">
        <div className="catalogue__header">
          ...
          <h1 className="catalogue__title">Women's Casual Wear</h1>
          <p className="catalogue__subtitle">Comfortable and versatile everyday collection</p>
        </div>
...
export default WomensCasualWear;
