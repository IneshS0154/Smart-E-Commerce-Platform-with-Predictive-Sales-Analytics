...
function WomensFormalCollection() {
  ...
  const fetchProducts = async () => {
    ...
    setError('');
    try {
      const response = await fetch('/api/products/catalogue/FEMALE/FORMAL_COLLECTION');
      if (response.ok) {
    ...
    <>
      ...
      <main className="catalogue">
        <div className="catalogue__header">
          ...
          <p className="catalogue__subtitle">Professional elegance and business sophistication</p>
        </div>
