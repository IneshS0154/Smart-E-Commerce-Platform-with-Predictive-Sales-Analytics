...
import './MensSportsActive.css';

const sportsActiveProducts = [
  {
    id: 1,
...
function MensSportsActive() {
  ...
  const categories = ['Shoes', 'Tops', 'Bottoms', 'Jackets', 'Accessories'];

  const filteredProducts = sportsActiveProducts.filter(product => {
    ...
    <>
      ...
      <main className="catalogue">
        <div className="catalogue__header">
          ...
          <h1 className="catalogue__title">Men's Sports & Active</h1>
          <p className="catalogue__subtitle">High-performance gear for athletes</p>
        </div>
...
export default MensSportsActive;
