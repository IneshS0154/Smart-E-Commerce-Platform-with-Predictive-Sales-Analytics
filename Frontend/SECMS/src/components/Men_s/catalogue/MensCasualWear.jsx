...
function MensCasualWear() {
  ...
  const categories = ['Casual Wear', 'Formal Collection', 'Sports & Active', 'Outerwear & Jackets', 'Party & Evening Wear'];
  ...
  const fetchProducts = async () => {
    ...
    setError('');
    try {
      const response = await fetch('/api/products/catalogue/MALE/CASUAL_WEAR');
      if (response.ok) {
