...
import './MensOuterwearJackets.css';

const outerwearJacketsProducts = [
  {
    id: 1,
...
function MensOuterwearJackets() {
  ...
  const filteredProducts = outerwearJacketsProducts.filter(product => {
    ...
    <>
      ...
      <main className="catalogue">
        <div className="catalogue__header">
          ...
          <h1 className="catalogue__title">Men's Outerwear & Jackets</h1>
          <p className="catalogue__subtitle">Premium layers for every season</p>
        </div>
...
export default MensOuterwearJackets;
