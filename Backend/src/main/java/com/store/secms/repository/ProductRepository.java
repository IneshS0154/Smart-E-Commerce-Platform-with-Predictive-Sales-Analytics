...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    /** Returns the N newest products for a given gender, ordered by createdAt DESC */
    List<Product> findByGenderOrderByCreatedAtDesc(ProductGender gender, Pageable pageable);
}
